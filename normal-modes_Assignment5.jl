...
# ╔═╡ a31f93e1-ccca-44e4-bb6b-d9a5c18397e1
Nodes_Table=Table( mode=[1,2,3,4,5,6,7,8,9], N1=[1,0,-1/3,-1/2,-3/5,-2/3,-5/7,-3/4,-7/9], N2=[-,1,1/3,0,-1/5,-1/3,-3/7,-1/2,-5/9], N3=[-,-,1,1/2,1/5,0,-1/7,-1/4,-3/9], N4=[-,-,-,1,3/5,1/3,1/7,0,-1/9], N5=[-,-,-,-,1,2/3,3/7,1/4,1/9], N6=[-,-,-,-,-,1,5/7,1/2,3/9], N7=[-,-,-,-,-,-,1,3/4,5/9], N8=[-,-,-,-,-,-,-,1,7/9], N9=[-,-,-,-,-,-,-,-,1])
...
# ╔═╡ e198a88f-be18-4de5-9f6d-d4a3d6ec3d2f
md"""
# Assignment Question 1 
Reason for the zero frequencies in the recorded spectra
"""

# ╔═╡ 04c66b9c-cdee-41d8-8f02-fd29bbef5604
md"""
	### Uniform Model
	"""

# ╔═╡ 3018d610-2839-413c-9aa7-5c6d79b087d5
md"""
## Observation:
### 1) Source at x=-1/2 and Receiver at x=1/2 
"""

# ╔═╡ 820592b7-2f22-4077-911d-c7d88003f528
md"""
##### The source and receiver position for observation 1: 
We can see the source and receiver position for observation 1 in the below image
"""

# ╔═╡ 19176a75-7556-4bc8-844c-c91362d96d79
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs11.png")

# ╔═╡ 6c1b638a-f174-4554-934f-da68f02e2a79
md"""
##### Time- Frequency plot For Observation 1
"""

# ╔═╡ 11cda38f-38fc-4b2a-9de5-7699fa314fe3
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs1.png")

# ╔═╡ 1c0577dc-6bed-4840-a087-07cc44f97f16
md"""
When we position the source at x=-1/2 and receiver at x=1/2 and restrict ourselves to 10 modes of the vibrating string.
For 10 modes we have 9 eigen values and 9 eigen frequency. But the number of non zero frequencies on recoded spectra observed by the receiver is 7. 
The reason behind this is because displacement of the at the nodes is zero.
Since both the Source and the Receiver are positioned at the node points of the 4th and 8th modes of string it is not concluded whether the zero frequency is due to Source or the reciever in this case.
"""

# ╔═╡ b2ce8f79-bfeb-42d7-9d9a-69949051811a
md"""
### 2) Source at x=1/4 and Receiver at x=1/2 with the same no. of modes as above.
"""

# ╔═╡ 4e47508b-dd99-4f48-9a8b-3596e3ee2386
md"""
##### The source and receiver position for observation 2:
We can see the source and receiver position for observation 2 in the below image
"""

# ╔═╡ 74dded44-1698-4f14-8af5-d51bacc5114f
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs21.png")

# ╔═╡ 6e74ef36-a119-4747-8c1c-1cced1c76d5a
md"""
##### Time- Frequency plot For Observation 2
"""

# ╔═╡ d2acddae-60e2-4091-9efd-675e150ce9e5
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs2.png")

# ╔═╡ d64fe5d8-d11e-4aac-a343-c01385d6d95f
md"""
When the Source is at x=1/4 and Receiver is at x=1/2 with the same no. of modes as above, the number of non zero frequencies on recoded spectra observed by the receiver is 8. But the 4th frequency is almost zero.
The Receiver is placed at the position at which it is the node of both 4th and 8th modes, the 8th eigen frequency is zero but the 4th eigen frequency has been observed and is non-zero(almost zero).
The source is placed at one of the nodes of the 8th mode of the string thus the eigen frequency is not observed because the string motion is not induced at that position.
Eventhough, we are able to see that the zero frequency is due to reciever and source locations, we are not able to conclude that the vanishing of eigen frequency in the recorded spectra is only due to source possition or only due to receiver position.
"""

# ╔═╡ 2e1c6684-5d1d-4cca-9191-658126dbc5df
md"""
### 3) Source at x=1/4 and Receiver in -0.55
"""

# ╔═╡ 0fa54e49-41bd-4ec9-995f-61e0362dc337
md"""
##### The source and receiver position for observation 3:
We can see the source and receiver position for observation 3 in the below image
"""

# ╔═╡ a9c270e8-7492-4026-858a-f829eeaf99ad
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/obs31.png")

# ╔═╡ 88fa3f2e-875a-44eb-ad56-665e53f188e0
md"""
##### Time- Frequency plot For Observation 3
"""

# ╔═╡ 3c81e7c7-5dd8-4152-b785-2b5751a74c9b
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/obs3.png")

# ╔═╡ e82b9be6-aefd-4dc9-bd85-b5301f14d7a4
md"""
Positioning Source at x=1/4 and Receiver in -0.55.
Using the same no of modes and a different Receiver position ( which is node of any of the 9 modes), the number of non zero frequencies on recoded spectra observed by the receiver is 9 now.
Since the Source is positioned at the node points of the 8th mode the 8th frequency is zero, and all the other frequencies are observed since the receiver is in a position where it is not the node of any. Hence, the receiver is also responsible for zero frequencies. 
"""

# ╔═╡ cf704739-a444-49e5-bd6a-93d7fff2fa0d
md"""
### REASONING:
Since the displacement at the nodes of the normal mode is zero. The recoded spectra shows zero values corresponding to some eigen frequencies
"""

# ╔═╡ fccd5b0f-8129-4bbe-9ca2-3ccced758f6d
md"""
# Assignment Question 2
Reasoning for the missing normal modes at some specific reciever and source positions
"""

# ╔═╡ 982631b8-1be2-45fe-b155-8a2b7e2e6b5d
md"""

### REASONING:
When the Source is at a node then it does not induce the corresponding mode and if the receiver is at a node then it does not record the corresponding mode.
Hence, the reason for the zero frequecies are both due to source and receiver positions.
"""

# ╔═╡ c56ed93f-1ff4-475b-9668-f757f146f74c
	md"""
	# Assignment Question 3
	"""

# ╔═╡ dc42543a-0bc3-43f6-8dd3-412055574c98
md"""
### Non uniform Model
Here we are considering two medium properties where velocity in first layer is 1.8 and second layer is 2.8 

"""

# ╔═╡ effb8d28-64db-416f-b422-42bff0f2cc5e
md"""
To know the changes due to the medium properties let us consider the same three source and receiver positions as we considered in case of Uniform Model

"""

# ╔═╡ fc51ba33-42b4-418c-b05f-b76fb01904ce
md"""
## Observation:
### 1) Source at x=-1/2 and Receiver at x=1/2 
"""

# ╔═╡ ab241e42-f8a6-4cfa-9d0f-076a04690b8c
md"""
##### The source and receiver position for observation 1: 
We can see the source and receiver position for observation 1 and the boundary denote the two medium seperation in the below image
"""

# ╔═╡ 7a7dbc04-ded4-4297-89e6-1ef4f10269f5
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs41.png")

# ╔═╡ 566cd3e8-720d-41b0-bc3d-16e34a87fa9e
md"""
##### Time- Frequency plot For Observation 1
"""

# ╔═╡ 9b115f22-2abb-42f6-b055-a46f0fa9fa00
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs4.png")

# ╔═╡ 504a8c25-f6a6-43e4-b947-e0cf6dd50480
md"""
We can see that the 4th frequency is almost zero and the others are non zero.
Since the source is at -1/2 which is the node of 4th and 8th frequency it is expected that both should be zero but the spectra has recorded non zero 8th frequency.
Also the receiver is at 1/2 which is again the node of 4th and 8th frequency it is expected that both should be zero but the spectra has recorded non zero 8th frequency.
But here the receiver is in a different medium thus due to principle of superposition of displcements in medium 1 and 2 the 4th frequency is unaffected but the 8th frequency is changed to become non-zero quantity.
"""

# ╔═╡ 9464fc8a-3745-4109-a28a-8a6785fe7841
md"""
### 2) Source at x=1/4 and Receiver at x=1/2 with the same no. of modes as above.
"""

# ╔═╡ b07d1c02-ce2d-4827-a001-6a7422e9011a
md"""
##### The source and receiver position for observation 2: 
We can see the source and receiver position for observation 2 
"""

# ╔═╡ fe91dd5f-4edb-48dc-ada3-af0b4b7b4419
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs51.png")

# ╔═╡ 08861784-7feb-4900-8f1b-aee92b7b5566
md"""
##### Time- Frequency plot For Observation 2
"""

# ╔═╡ c4354d41-b2fc-4584-83b7-40ecba7c90c6
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs5.png")

# ╔═╡ 1702e2b7-4266-4e2f-bfd2-89da5d793a52
md"""
We can see that the spectra has recorded all the eigen frequencies.
Since the source is at 1/4 which is the node of 8th frequency it is expected that it should be zero but the spectra has recorded non zero 8th frequency.
Also the receiver is at 1/2 which is again the node of 4th and 8th frequency it is expected that both should be zero but the spectra has recorded non zero frequency.
But here the source and receiver is in a different medium thus due to principle of superposition of displacements in medium 1 and 2 the frequencies are shown to be non zero. 
"""

# ╔═╡ 969b517b-d13d-47be-9a18-649cf71e7846
md"""
### 3) Source at x=1/4 and Receiver in -0.55
"""

# ╔═╡ 6fbeed2f-ef78-498a-b117-c95dc49ae92c
md"""
##### The source and receiver position for observation 3: 
We can see the source and receiver position for observation 3 
"""

# ╔═╡ c44048b5-19ce-4923-b6b8-d6487dbf5f01
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs61.png")

# ╔═╡ 3858ebd8-b106-463c-8f81-5b77d280eebe
md"""
##### Time- Frequency plot For Observation 3
"""

# ╔═╡ 3c6cf030-37ee-4e03-bd4a-e961837b4d71
PlutoUI.LocalResource("/Users/aswinivj/Desktop/Seismology/Normal mode Assignment/Obs6.png")

# ╔═╡ e158c926-c067-4ae7-9f8f-0e5369cb8fef
md"""
We can see that the spectra has recorded all the eigen frequencies but the fourth and seventh is almost zero.
Since the source is at 1/4 which is the node of 8th frequency it is expected that it should be zero but the spectra has recorded non zero 8th frequency.
Also the receiver is at -0.55 which is not the node of any of the modes it should not affect the recorded spectra.
It would be expected that only the 4th frequency should be zero in recorded spectra.
But here the source and receiver is in a different medium thus due to principle of superposition of displacements in medium 1 and 2 the frequencies are shown to be non-zero.
"""

# ╔═╡ 08fdbebc-a02f-4378-9cbf-68ca7b7cee39
md"""
### REASONING:
When the Source is at a node then it does not induce the corresponding mode and if the receiver is at a node then it does not record the corresponding mode.
But when the there is a non-uniform model the velocity change would also modify the occurence of zero frequency record. 
Hence, the reason for the zero frequecies are due to source position, receiver position and also because of velocity change.
"""
...
# ╔═╡ 6cd2e78f-8059-46e5-9dd4-cd11715aa248
md"""
#### Plots
...
begin
	function plot_up(up,xgrid,pa,medium,n_layers)
    	...
    	@gif for it in 1:2:100
        	plot(xgrid, up[it, :], ylim=ylim, xtick=-1:0.1:1, size= [1000,500], label=nothing, title="Displacement of 1D Earth (it=$it)", ylabel="Amplitude", w=2)
...
# ╔═╡ c7649b3b-b87f-4bd6-979e-ecc243941957
md"""
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "5026238361e16f724c40c5b1a8403d31ff592193"
